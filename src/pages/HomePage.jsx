...
function InstagramGallery() {
  ...
  // Featured Instagram post URLs from @calstateyoyo
  const instagramPosts = [
    'https://www.instagram.com/p/DTzPPEDkf5n/',
    'https://www.instagram.com/p/DTyTMRoEtrm/',
    'https://www.instagram.com/p/DTySgukEu7s/',
  ]
      ...
      <Container className="relative z-10">
        <AnimatedSection animation="fadeUp" className="text-center mb-12">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="text-sm font-mono text-pink-500 tracking-wider uppercase">
              @calstateyoyo
            </span>
          </div>
          <h2 className={`font-display text-3xl sm:text-4xl md:text-5xl font-bold mb-6 ${
            ...
            Follow Us on{' '}
            <GradientText gradient="cal">Instagram</GradientText>
          </h2>
          <p className={`max-w-2xl mx-auto text-lg leading-relaxed ${
            isDark ? 'text-gray-400' : 'text-surface-600'
          }`}>
            Stay up to date with the latest news, highlights, and behind-the-scenes content
            from California State Yo-Yo Contest.
          </p>
        </AnimatedSection>
            ...
            <div key={index} className="flex justify-center">
              <blockquote
                ...
                style={{
                  ...
                  borderRadius: '12px',
                  boxShadow: isDark
                    ? '0 0 1px 0 rgba(255,255,255,0.1), 0 1px 10px 0 rgba(0,0,0,0.3)'
        ...
        <AnimatedSection animation="fadeUp" className="text-center">
          <a
            href="https://www.instagram.com/calstateyoyo/"
            target="_blank"
